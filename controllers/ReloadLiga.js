...
const {
  UserV, LigaV, User_LigaV, JogoV, User_GameV, User_GameM, ConfLiga
...
module.exports = {
  async ReloadLiga(id){
    console.log("ReloadLiga entrou id ->", id);
    ...
    if(lg){
      let confg = new ConfLiga(lg.confg_da_liga);
      let liga = new LigaV(lg, confg);
      ...
      return await computar_destaques(liga);
    }
